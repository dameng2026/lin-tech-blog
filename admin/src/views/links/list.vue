      ...
      <div class="flex justify-between items-center">
        <ElForm :inline="true" :model="searchForm" class="flex-1">
          <ElFormItem label="网站名称">
            <ElInput v-model="searchForm.name" placeholder="搜索网站" clearable @keyup.enter="handleSearch" />
          </ElFormItem>
          <ElFormItem label="分类">
            <ElSelect v-model="searchForm.category" placeholder="选择分类" clearable style="width: 140px">
...
const breadcrumbItems = [
  ...
  { label: '友链列表', path: '/links/friend-links' }
]
    ...
    columnsFactory: () => [
      ...
      { prop: 'createdAt', label: '申请时间', width: 180 },
      {
        ...
        formatter: (row) => {
          ...
          actions.push(h(ArtButtonTable, { type: 'edit', onClick: () => handleEdit(row), vAuth: 'edit' }))
