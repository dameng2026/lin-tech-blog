...
<template>
  <div class="menu-page art-full-height">
    ...
    <ElCard class="art-table-card rounded-xl shadow-sm border border-[var(--art-card-border)]">
      <!-- 表格头部 -->
      <ArtTableHeader
        :showZebra="false"
        :loading="loading"
      ...
      >
        <template #left>
          <ElButton size="small" v-auth="'add'" @click="handleAddMenu" v-ripple> 添加菜单 </ElButton>
