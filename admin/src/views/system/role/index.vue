...
<template>
  <div class="art-full-height">
    ...
    <ElCard class="art-table-card rounded-xl shadow-sm border border-[var(--art-card-border)]" :style="{ 'margin-top': showSearchBar ? '12px' : '0' }">
      <ArtTableHeader
      ...
      >
        <template #left>
          <ElSpace wrap>
            <ElButton size="small" @click="showDialog('add')" v-ripple>新增角色</ElButton>
          </ElSpace>
        </template>
      </ArtTableHeader>
