﻿﻿﻿﻿<template>
  <div class="min-h-screen bg-[#f8f9fc]">
    ...
    <!-- 左侧侧边栏 - 桌面端 -->
    <aside class="hidden lg:flex w-64 h-screen bg-white border-r border-gray-200 flex-col fixed left-0 top-0 z-20">
      <div class="p-6 border-b border-gray-200 shrink-0">
        <h1 class="text-xl font-bold text-blue-600 flex items-center">
          <span class="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold mr-2">L</span>
          Lin's Tech Blog
        </h1>
      </div>
      ...
      <div class="mt-auto flex flex-col border-t border-gray-200 shrink-0">
        <div class="p-4">
          <div class="flex justify-center space-x-4 mb-4">
            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200">
              <img src="/icons/calendar.svg" alt="日历" class="w-4 h-4">
            </a>
            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200">
            ...
            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200">
              <img src="/icons/email-black.svg" alt="信息" class="w-4 h-4">
            </a>
          </div>
        ...
        <header class="hidden lg:block px-6 py-4 border-b border-gray-200 bg-[#fefefe]">
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
              ...
              <button @click="openAuthModal" class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold cursor-pointer hover:bg-blue-700 transition-colors">
                L
              </button>
            </div>
          </div>
        ...
        <header class="lg:hidden px-4 py-3 border-b border-gray-100 bg-white">
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
              ...
              <button @click="openAuthModal" class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold">
                L
              </button>
            </div>
          </div>
